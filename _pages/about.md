...
[**timeSeriesQC**](https://github.com/yryrena/timeSeriesQC) provides a unified framework for quality control of time series data. It brings together a suite of diagnostic tools for detecting, flagging, and correcting common data issues such as outliers, missing values, seasonal anomalies, and structural breaks. Designed with both accessibility and rigor in mind, the package offers clear syntax, customizable workflows, and informative visualizations to streamline the QC process. By automating routine checks while allowing flexibility for user-defined rules, the package makes it easier for researchers to ensure the reliability of their time series before proceeding with modeling or analysis.
